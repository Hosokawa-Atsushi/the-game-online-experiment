       ...
       (flet ((bad-condition-exit (string)
         ...
         (let ((segments (segment-production definition buffers))
           ...
           (if (eq segments :error)
             ...
             (car (setf (gethash definition (procedural-condition-parse-table procedural)) (cons conditions (reverse new-slots))))))))
  ...
  (aif (gethash (cons definition conditions) (procedural-action-parse-table procedural))
       ...
       (flet ((bad-action-exit (string)
         ...
         (let ((segments (segment-production definition buffers))
           ...
           (car (setf (gethash (cons definition conditions) (procedural-action-parse-table procedural)) (cons actions (reverse new-slots))))))))
