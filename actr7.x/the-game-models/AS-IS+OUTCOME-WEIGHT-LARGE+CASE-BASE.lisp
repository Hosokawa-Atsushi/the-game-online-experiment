...
(define-model AS-IS+OUTCOME-WEIGHT-LARGE+CASE-BASE
  ...
  (chunk-type learned-info m-1st m-2nd m-3rd m-4th m-5th o-1st o-2nd o-3rd o-4th o-5th mresult)
  ...
  (set-similarities (win lose -100) (win draw -50) (lose draw -50))
